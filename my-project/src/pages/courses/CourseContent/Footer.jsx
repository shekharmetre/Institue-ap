...
const Footer = () => {
  return (
    <div className="min-h-screen md:hidden py-6 flex flex-col justify-center sm:py-12">
    ...
    <div className="bg-white min-w-1xl flex flex-col rounded-xl shadow-lg">
      ...
      <div className="bg-gray-200 w-full flex flex-col items-center">
        ...
        <div className="w-3/4 flex flex-col">
          <textarea rows={3} className="p-4 text-gray-500 rounded-xl resize-none" />
          <button className="py-3 my-8 text-lg bg-gradient-to-r from-purple-500 to-indigo-600 rounded-xl text-white" placeholder="Feedback to better us">
            Rate now
          </button>
        </div>
      </div>
